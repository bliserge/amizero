...
<body>
    <div class="container">
        <center class="justify-content-center mt-15">
            <form class="form_container " action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="input_container">
                    ...
                    <input placeholder="username" title="Inpit title" name="email" type="text" class="input_field" id="email_field">
                </div>
                <div class="input_container">
